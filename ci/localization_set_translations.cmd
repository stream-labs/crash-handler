...
%GETTEXT_BIN%xgettext.exe --keyword=translate:1,1t crash-handler-process\platforms\util-win.cpp crash-handler-process\platforms\upload-window-win.cpp -d messages -p crash-handler-process\locale
