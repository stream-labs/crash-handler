...
typedef /* [helpstring][uuid] */ DECLSPEC_UUID("12782009-FE90-4877-9730-E5E183669B19") enum WinHttpRequestOption {
...
typedef /* [uuid] */ DECLSPEC_UUID("9d8a6df8-13de-4b1f-a330-67c719d62514") enum WinHttpRequestAutoLogonPolicy {
...
typedef /* [uuid] */ DECLSPEC_UUID("152a1ca2-55a9-43a3-b187-0605bb886349") enum WinHttpRequestSslErrorFlags {
...
typedef /* [uuid] */ DECLSPEC_UUID("6b2c51c1-a8ea-46bd-b928-c9b76f9f14dd") enum WinHttpRequestSecureProtocols {
...
typedef struct IWinHttpRequestVtbl {
	...
	/* [local] */ HRESULT(STDMETHODCALLTYPE *Invoke)(IWinHttpRequest *This,
							 /* [annotation][in] */
	...
	/* [helpstring][id] */ HRESULT(STDMETHODCALLTYPE *SetProxy)(IWinHttpRequest *This,
								    /* [in] */ HTTPREQUEST_PROXY_SETTING ProxySetting,
								    /* [optional][in] */ VARIANT ProxyServer,
								    /* [optional][in] */ VARIANT BypassList);

	DECLSPEC_XFGVIRT(IWinHttpRequest, SetCredentials)
	/* [helpstring][id] */ HRESULT(STDMETHODCALLTYPE *SetCredentials)(IWinHttpRequest *This,
									  /* [in] */ BSTR UserName,
									  /* [in] */ BSTR Password,
									  /* [in] */ HTTPREQUEST_SETCREDENTIALS_FLAGS Flags);

	DECLSPEC_XFGVIRT(IWinHttpRequest, Open)
	/* [helpstring][id] */ HRESULT(STDMETHODCALLTYPE *Open)(IWinHttpRequest *This,
								/* [in] */ BSTR Method,
								/* [in] */ BSTR Url,
								/* [optional][in] */ VARIANT Async);

	DECLSPEC_XFGVIRT(IWinHttpRequest, SetRequestHeader)
	/* [helpstring][id] */ HRESULT(STDMETHODCALLTYPE *SetRequestHeader)(IWinHttpRequest *This,
									    /* [in] */ BSTR Header,
									    /* [in] */ BSTR Value);

	DECLSPEC_XFGVIRT(IWinHttpRequest, GetResponseHeader)
	/* [helpstring][id] */ HRESULT(STDMETHODCALLTYPE *GetResponseHeader)(IWinHttpRequest *This,
									     /* [in] */ BSTR Header,
									     /* [retval][out] */ BSTR *Value);

	DECLSPEC_XFGVIRT(IWinHttpRequest, GetAllResponseHeaders)
	/* [helpstring][id] */ HRESULT(STDMETHODCALLTYPE *GetAllResponseHeaders)(IWinHttpRequest *This,
										 /* [retval][out] */ BSTR *Headers);

	DECLSPEC_XFGVIRT(IWinHttpRequest, Send)
	/* [helpstring][id] */ HRESULT(STDMETHODCALLTYPE *Send)(IWinHttpRequest *This,
								/* [optional][in] */ VARIANT Body);

	DECLSPEC_XFGVIRT(IWinHttpRequest, get_Status)
	/* [helpstring][id][propget] */ HRESULT(STDMETHODCALLTYPE *get_Status)(IWinHttpRequest *This,
									       /* [retval][out] */ long *Status);

	DECLSPEC_XFGVIRT(IWinHttpRequest, get_StatusText)
	/* [helpstring][id][propget] */ HRESULT(STDMETHODCALLTYPE *get_StatusText)(IWinHttpRequest *This,
										   /* [retval][out] */ BSTR *Status);

	DECLSPEC_XFGVIRT(IWinHttpRequest, get_ResponseText)
	/* [helpstring][id][propget] */ HRESULT(STDMETHODCALLTYPE *get_ResponseText)(IWinHttpRequest *This,
										     /* [retval][out] */ BSTR *Body);

	DECLSPEC_XFGVIRT(IWinHttpRequest, get_ResponseBody)
	/* [helpstring][id][propget] */ HRESULT(STDMETHODCALLTYPE *get_ResponseBody)(IWinHttpRequest *This,
										     /* [retval][out] */ VARIANT *Body);

	DECLSPEC_XFGVIRT(IWinHttpRequest, get_ResponseStream)
	/* [helpstring][id][propget] */ HRESULT(STDMETHODCALLTYPE *get_ResponseStream)(IWinHttpRequest *This,
										       /* [retval][out] */ VARIANT *Body);

	DECLSPEC_XFGVIRT(IWinHttpRequest, get_Option)
	/* [id][propget] */ HRESULT(STDMETHODCALLTYPE *get_Option)(IWinHttpRequest *This,
								   /* [in] */ WinHttpRequestOption Option,
								   /* [retval][out] */ VARIANT *Value);

	DECLSPEC_XFGVIRT(IWinHttpRequest, put_Option)
	/* [id][propput] */ HRESULT(STDMETHODCALLTYPE *put_Option)(IWinHttpRequest *This,
								   /* [in] */ WinHttpRequestOption Option,
								   /* [in] */ VARIANT Value);

	DECLSPEC_XFGVIRT(IWinHttpRequest, WaitForResponse)
	/* [helpstring][id] */ HRESULT(STDMETHODCALLTYPE *WaitForResponse)(IWinHttpRequest *This,
									   /* [optional][in] */ VARIANT Timeout,
									   /* [retval][out] */ VARIANT_BOOL *Succeeded);

	DECLSPEC_XFGVIRT(IWinHttpRequest, Abort)
	/* [helpstring][id] */ HRESULT(STDMETHODCALLTYPE *Abort)(IWinHttpRequest *This);

	DECLSPEC_XFGVIRT(IWinHttpRequest, SetTimeouts)
	/* [helpstring][id] */ HRESULT(STDMETHODCALLTYPE *SetTimeouts)(IWinHttpRequest *This,
								       /* [in] */ long ResolveTimeout,
								       /* [in] */ long ConnectTimeout,
								       /* [in] */ long SendTimeout,
	...
	/* [helpstring][id] */ HRESULT(STDMETHODCALLTYPE *SetClientCertificate)(IWinHttpRequest *This,
										/* [in] */ BSTR ClientCertificate);

	DECLSPEC_XFGVIRT(IWinHttpRequest, SetAutoLogonPolicy)
	/* [helpstring][id] */ HRESULT(STDMETHODCALLTYPE *SetAutoLogonPolicy)(IWinHttpRequest *This,
...
#define IWinHttpRequest_SetProxy(This, ProxySetting, ProxyServer, BypassList) ((This)->lpVtbl->SetProxy(This, ProxySetting, ProxyServer, BypassList))
...
typedef struct IWinHttpRequestEventsVtbl {
	...
	DECLSPEC_XFGVIRT(IUnknown, AddRef)
	ULONG(STDMETHODCALLTYPE *AddRef)(IWinHttpRequestEvents *This);

	DECLSPEC_XFGVIRT(IUnknown, Release)
	ULONG(STDMETHODCALLTYPE *Release)(IWinHttpRequestEvents *This);

	DECLSPEC_XFGVIRT(IWinHttpRequestEvents, OnResponseStart)
	void(STDMETHODCALLTYPE *OnResponseStart)(IWinHttpRequestEvents *This,
						 /* [in] */ long Status,
						 /* [in] */ BSTR ContentType);

	DECLSPEC_XFGVIRT(IWinHttpRequestEvents, OnResponseDataAvailable)
	void(STDMETHODCALLTYPE *OnResponseDataAvailable)(IWinHttpRequestEvents *This,
							 /* [in] */ SAFEARRAY **Data);

	DECLSPEC_XFGVIRT(IWinHttpRequestEvents, OnResponseFinished)
	void(STDMETHODCALLTYPE *OnResponseFinished)(IWinHttpRequestEvents *This);

	DECLSPEC_XFGVIRT(IWinHttpRequestEvents, OnError)
	void(STDMETHODCALLTYPE *OnError)(IWinHttpRequestEvents *This,
					 /* [in] */ long ErrorNumber,
...
#define IWinHttpRequestEvents_QueryInterface(This, riid, ppvObject) ((This)->lpVtbl->QueryInterface(This, riid, ppvObject))

#define IWinHttpRequestEvents_AddRef(This) ((This)->lpVtbl->AddRef(This))

#define IWinHttpRequestEvents_Release(This) ((This)->lpVtbl->Release(This))

#define IWinHttpRequestEvents_OnResponseStart(This, Status, ContentType) ((This)->lpVtbl->OnResponseStart(This, Status, ContentType))

#define IWinHttpRequestEvents_OnResponseDataAvailable(This, Data) ((This)->lpVtbl->OnResponseDataAvailable(This, Data))

#define IWinHttpRequestEvents_OnResponseFinished(This) ((This)->lpVtbl->OnResponseFinished(This))
